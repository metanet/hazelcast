 ...
 * <p>
 * {@link ApplyRaftGroupMembersCommand} Raft operation is created with members according to the member parameter
...
public class MembershipChangeTask implements Runnable {
    ...
    public void run() {
        ...
        new ReplicateTask(raftNode, new ApplyRaftGroupMembersCommand(members), resultFuture).run();
    }

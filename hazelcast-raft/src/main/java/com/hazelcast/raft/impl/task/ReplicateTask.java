...
public class ReplicateTask implements Runnable {
    ...
    public void run() {
        ...
        handleRaftCommand(newEntryLogIndex, operation);
    ...
    private void handleRaftCommand(long logIndex, Object operation) {
        if (operation instanceof TerminateRaftGroupCommand) {
            ...
            ApplyRaftGroupMembersCommand op = (ApplyRaftGroupMembersCommand) operation;

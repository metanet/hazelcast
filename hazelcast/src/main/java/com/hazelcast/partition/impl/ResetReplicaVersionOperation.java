...
final class ResetReplicaVersionOperation extends AbstractOperation
    ...
    public ResetReplicaVersionOperation(PartitionReplicaAssignmentReason reason, boolean initialAssignment) {
        this.reason = reason;
    ...
    public void run() throws Exception {
        ...
        if (setWaitingSyncFlag) {
            ...
            if (reason == PartitionReplicaAssignmentReason.ASSIGNMENT) {

 ...
 *
 * @see Semaphore#acquire(SemaphoreInvocationKey, boolean)
 */
public class AcquirePermitsOp extends AbstractSemaphoreOp implements CallerAware, IndeterminateOperationStateAware {
    ...
    public Object run(CPGroupId groupId, long commitIndex) {
        ...
        AcquireResult result = service.acquirePermits(groupId, name, getSemaphoreInvocationKey(commitIndex, permits), timeoutMs);

...
public class ResetReplicaVersionOperationTest {
    ...
    @Test
    public void test_setSyncWaitingFlag_onMemberRemove()
            throws Exception {
    ...
    @Test
    public void test_setSyncWaitingFlag_onAssignment()
            throws Exception {
        final long[] versions = {6, 5, 4, 3, 2, 1};
        final long[] updatedVersions = {-1, 5, 4, 3, 2, 1};
    ...
    @Test
    public void test_notSetSyncWaitingFlag_onInitialAssignment()
            throws Exception {
        final long[] versions = {6, 5, 4, 3, 2, 1};
    ...
    @Test
    public void test_keepPreviousSyncWaitingFlags_onMemberRemove()
            throws Exception {
    ...
    @Test
    public void test_resetPreviousSyncWaitingFlags_onAssignment()
            throws Exception {
        final long[] versions = {6, -1, -1, 3, 2, 1};
    ...
    private void testResetReplicaVersionOperation(final int partitionId, final int replicaIndex, final long[] versions,
                                                  final long[] updatedVersions, final PartitionReplicaAssignmentReason reason,
    ...
    private ResetReplicaVersionOperation createOperation(int partitionId, int replicaIndex,
                                                         PartitionReplicaAssignmentReason reason, boolean initialAssignment) {
